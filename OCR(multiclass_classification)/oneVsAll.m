...
%     predictOneVsAll.m
%
% oneVsAll() function trains multiple logistic regression classifiers
% and returns trained weight matrix 'all_theta'.
...
for c = 1:(num_labels)      % training for each labels, using provided optimizing function
    options = optimset('GradObj','on','MaxIter',50);
